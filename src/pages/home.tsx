    ...
    return (
        <div className="home-page flex flex-col  px-10 md:px-28  bg-gradient-to-b from-sky-900 to-zinc-300   ">
            ...
            <div className="home-btns flex flex-col  justify-between md:flex-row  w-2/1  pt-12  text-slate-50  ">
                <button className=" md:basis-1/2 my-2 p-4  md:mr-4 py-2 hover:bg-blue-600 font-bold    rounded-md  lg:text-2xl font-regular text-slate50 bg-blue-500" >Get Started</button>
                <button className=" md:basis-1/2 my-2 p-4  md:ml-4 py-2 border-2 hover:border-blue-600 border-slate-50  rounded-md font-semibold lg:text-2xl " >Login</button>
